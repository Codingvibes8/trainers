...
export default function RegisterPage() {
  ...
  return (
    <div className="flex min-h-[calc(100vh-80px)] items-center justify-center bg-slate-50 px-4 py-12 dark:bg-slate-900">
        ...
        <div className="rounded-2xl bg-white p-8 shadow-xl dark:bg-slate-800">
          <div className="mb-6 text-center">
            ...
            <p className="mt-2 text-slate-600 dark:text-slate-400">
              Join NexShop for exclusive deals and faster checkout
            </p>
          </div>
          ...
          <div className="mb-6 grid grid-cols-2 gap-4">
            <button
              ...
              className="flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-3 text-sm font-medium text-slate-700 transition-colors hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-300 dark:hover:bg-slate-700"
            >
